...
def test_read_v5_document_complex(datadir):
    doc = DesignSpaceDocument.fromfile(datadir / "test_v5_complex.designspace")
    ...
    expected_axes = [
        Axis(
            ...
            maximum=900,
            default=400,
            map=[(300, 40), (400, 90), (500, 130), (700, 150), (900, 210)],
            labelOrdering=1,
            labels=[
                AxisLabel(name="Light", userValue=300),
                AxisLabel(
                    name="Regular", userValue=400, elidable=True, linkedUserValue=700
                ),
                AxisLabel(name="Medium", userValue=500),
        ...
        DiscreteAxis(
            ...
            labelOrdering=2,
            labels=[
                AxisLabel(name="Condensed", userValue=75),
                AxisLabel(
                    name="Normal", elidable=True, userValue=100, linkedUserValue=75
                ),
            ],
        ),
        DiscreteAxis(
        ...
        DiscreteAxis(
            ...
            labelOrdering=3,
            labels=[
                AxisLabel(name="Text", userValue=0, elidable=True),
                AxisLabel(name="Display", userValue=1),
            ],
        ),
        Axis(
            tag="DRKM",
            ...
            labelOrdering=0,
            labels=[
                AxisLabel(name="Off", userValue=0, elidable=True, linkedUserValue=1),
                AxisLabel(name="Dark", userValue=1),
            ],
        ),
    ]
    ...
    expected_variable_fonts = [
        ...
        VariableFont(
            name="TestDisplayVF_DRKM",
            axisSelection=[
                DiscreteAxisSelector(name="Display", userValue=1),
                AxisSelector(name="Dark"),
            ],
        ),
        VariableFont(
            name="TestCdVF_DRKM",
            axisSelection=[
                DiscreteAxisSelector(name="Weight", userValue=90),
                AxisSelector(name="Dark"),
            ],
        ),
        VariableFont(
            name="TestItalics_Wght",
            axisSelection=[
                AxisSelector(
                    name="Weight", userMinimum=400, userDefault=400, userMaximum=700
                ),
